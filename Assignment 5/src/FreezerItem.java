...
public class FreezerItem extends PerishableItem {
    //Constructor
    FreezerItem(String Name, float Price, float Weight, boolean Perish){
        super(Name, Price, Weight, Perish);
    }
    FreezerItem(String Name, float Price, float Weight) {
        super(Name, Price, Weight);
    }
    // toString Method
    public String toString() { return super.toString() + "[keep frozen]"; }
}